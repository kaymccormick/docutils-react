...
export default function(e) {
	...
	/**/ Desc: (props) => React.createElement('div', { className: classnames(props.className, 'doc-desc', `doc-domain-${props.domain}`, `doc-objtype-${props.objType}`, `doc-desctype-${props.descType}`) }, props.children),
	/**/ Section: wrapElement('section'),
	/**/ Title: (props) => e('h1', { 'className': classNames(props.className, 'doc-title') }, props.children),
	/**/ BulletList: wrapElement('ul'),
	/**/ ListItem: wrapElement('li'),
